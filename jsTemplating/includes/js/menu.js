...
function Menu(label) {
    ...
    this.childMenuIcon = "includes/images/arrow.gif";
    this.childMenuIconHilite = "includes/images/arrow2.gif";
...
function writeMenus(container) {
    ...
    for (var i=0; i<container.menus.length; i++, countMenus++) {
        ...
        content += ''+
        '<DIV ID="menuLayer'+ countMenus +'" STYLE="cursor:hand;position:absolute;left:10;top:1;visibility:hidden;">\n'+
        '  <DIV ID="menuLite'+ countMenus +'" STYLE="cursor:hand;position:absolute;left:'+ proto.menuBorder +';top:'+ proto.menuBorder +';visibility:hide;" onMouseOut="hideMenu(this);">\n'+
        '    <DIV ID="menuFg'+ countMenus +'" STYLE="cursor:hand;position:absolute;left:1;top:1;visibility:hide;">\n'+
        '';
        var x=i;
        for (var i=0; i<menu.items.length; i++) {
            ...
            var dText   = '<DIV ID="menuItemText'+ countItems +'" STYLE="cursor:hand;position:absolute;left:' + proto.menuItemIndent + ';top:0;color:'+ proto.fontColor +';">'+ item +'</DIV>\n<DIV ID="menuItemHilite'+ countItems +'" STYLE="cursor:hand;position:absolute;left:' + proto.menuItemIndent + ';top:0;color:'+ proto.fontColorHilite +';visibility:hidden;">'+ item +'</DIV>';
            if (item == "separator") {
    ...
    if (container.document.layers) {
        ...
        for (var x=0; x<container.menus.length; x++) {
            ...
            proto.menuItemWidth = proto.menuItemWidth || 230;
...
function menuFadeSet()  {
	fadeSession = 1;
	timerID=setTimeout("menuFade()", 2000);
	}
