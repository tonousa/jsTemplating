...
function loadMenus() {
    ...
    onlineMenu.addMenuItem("Driver License Renewal", "location='http://dps.texasonline.state.tx.us'");
    ...
    onlineMenu.addMenuItem("Concealed Handgun Renewal", "location='http://www.texasonline.state.tx.us/NASApp/txdps/chl/common/jsp/welcome.jsp'");
    ...
    geninfoMenu.addMenuItem("Computerized Criminal History", "location='/cch/'");
    geninfoMenu.addMenuItem("Austin HQ Map", "location='/hqmap_austin.htm'");
    geninfoMenu.addMenuItem("Complaint Process", "location='/director_staff/internal_affairs/complaint.htm'");
    ...
    aboutMenu.addMenuItem("DL Locations", "location='/administration/driver_licensing_control/dloffices.htm'");
    ...
    jobsMenu.addMenuItem("Employment Listings", "location='/administration/staff_support/human_resources/index2.htm'");
    jobsMenu.addMenuItem("Become a Trooper", "location='/trainingacademy/recruiting/traineelinks.htm'");
